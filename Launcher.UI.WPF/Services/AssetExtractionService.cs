...
public class AssetExtractionService : IAssetExtractionService
{
    ...
    private readonly string[] _defaultIcons = { "fabric-default.png", "forge-default.png", "logo.png", "neoforge-default.png", "optifine-default.png", "quilt-default.png" };
        ...
        foreach (var fileName in fileNames)
        {
            ...
            if (!File.Exists(destPath) || new FileInfo(destPath).Length == 0)
            {
                ...
                if (!string.IsNullOrEmpty(resourceName))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"[Assets] Restored: {fileName}");
                }
                else
                {
